...
exports.getDashboardFeed = async (universityId, limit = 10, cursor = null) => {
  ...
  // For this exercise, I'll optimize the two queries and merge them, but implement cursor logic for the merged result 
  // OR simulate a unified query if I were to refactor.
